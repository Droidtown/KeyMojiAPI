    ...
    result = {'msg': 'Success!',
              'results': [{'cursing': False,
                          ...
                          {'cursing': False,
                           ...
                           'sentiment': 'neutral'},
                          {'cursing': False,
                           'input_str': '鬼殺隊一直在對你們有利的黑夜中戰鬥',
                           'score': 0.0267,
                           'sentiment': 'neutral'},
                          {'cursing': False,
                           'input_str': '我們都是有血有肉之軀的人',
                           'score': -0.1,
                           'sentiment': 'neutral'},
                          {'cursing': False,
                           'input_str': '受傷之後無法簡單治好',
                           'score': -0.2147,
                           'sentiment': 'negative'},
                          {'cursing': False,
                           'input_str': '失去的性命也無法挽回⋯⋯大哥沒有輸',
                           'score': -0.4778,
                           'sentiment': 'negative'},
                          {'cursing': False,
                           'input_str': '他真的到了最後',
                          ...
                          {'cursing': False,
                           ...
                           'sentiment': 'positive'},
                          {'cursing': False,
                           'input_str': '一直以來你在我面前擋住了很多攻擊',
                           'score': 0.2519,
                           'sentiment': 'positive'},
                          {'cursing': False,
                           'input_str': '一直以來你都沒有放棄要成為更好的自己',
                           'score': 0.5306,
                           'sentiment': 'positive'},
                          {'cursing': False,
                           'input_str': '一直以來有一個懦弱的我',
                           'score': -0.4588,
                           'sentiment': 'negative'},
                          {'cursing': False,
                           'input_str': '一直躲在你後面',
                          ...
                          {'cursing': False,
                           ...
                           'sentiment': 'positive'},
                          {'cursing': False,
                           'input_str': '謝謝你一直以來的照顧',
                           'score': 0.3056,
                           'sentiment': 'positive'},
                          {'cursing': False,
                           'input_str': '沒有讓在場的任何一個人死去',
                           'score': 0.4019,
                           'sentiment': 'positive'}],
              'sense': 'sense2',
              'status': True,
              'version': 'v102'}
    print(keymoji._sense2Visual(result, "sense2", "sense2"))